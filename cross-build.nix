...
defaultPlatformProject.pkgs.lib.mapAttrs (_: pkgs: rec {
  ...
  propellor = import ./default.nix { nativePkgs = pkgs;
                                     customModules = [ { packages.propellor.dontStrip = false; } ] ++ (if pkgs.stdenv.hostPlatform.isMusl then 
                                                        [
                                                          ...
                                                          { packages.propellor.configureFlags = 
                                                            [
